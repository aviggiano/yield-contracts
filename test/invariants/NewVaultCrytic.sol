...
contract NewVaultHarness is STETHVault, PropertiesAsserts, CryticIERC4626Internal {
    constructor(
...
contract NewVaultCrytic is CryticERC4626PropertyTests {
    constructor() {
        ...
        NewVaultHarness _vault = new NewVaultHarness(
            _configuration,
